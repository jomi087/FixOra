...
import { IVerifyPasswordUseCase } from "../../application/interfacetemp/useCases/client/IVerifyPasswordUseCase";
import validateFile from "../validations/fileValidation";
import { IKYCRequestUseCase } from "../../application/interfacetemp/useCases/client/IKYCRequestUseCase";
import { HttpStatusCode } from "../../shared/enums/HttpStatusCode";
import { Messages } from "../../shared/const/Messages";
import { IGetActiveProvidersUseCase } from "../../application/interfacetemp/useCases/client/IGetActiveProvidersUseCase";
import { IUpdateProfileUseCase } from "../../application/interfacetemp/useCases/client/IUpdateProfileUseCase";
import { IProviderInfoUseCase } from "../../application/interfacetemp/useCases/client/IProviderInfoUseCase";
import { IBookingUseCase } from "../../application/interfacetemp/useCases/client/IBookingUseCase";
import { ICreatePaymentUseCase } from "../../application/interfacetemp/useCases/client/ICreatePaymentUseCase";
import { IActiveServiceUseCase } from "../../application/interfacetemp/useCases/client/IActiveServiceUseCase";
import { IResetPasswordUseCase } from "../../application/interfacetemp/useCases/auth/IResetPasswordUseCase";
import { IVerifyPaymentUseCase } from "../../application/interfacetemp/useCases/client/IVerifyPaymentUseCase";
import { IBookingHistoryUseCase } from "../../application/interfacetemp/useCases/client/IBookingHistoryUseCase";
import { IGetBookingDetailsUseCase } from "../../application/interfacetemp/useCases/client/IGetBookingDetailsUseCase";
import { IWalletTopUpUseCase } from "../../application/interfacetemp/useCases/client/IWalletTopUpUseCase";
import { IGetUserwalletInfoUseCase } from "../../application/interfacetemp/useCases/client/IGetUserwalletInfoUseCase";
import { IWalletPaymentUseCase } from "../../application/interfacetemp/useCases/client/IWalletPaymentUseCase";
import { ICancelBookingUseCase } from "../../application/interfacetemp/useCases/client/ICancelBookingUseCase";
import { IRetryAvailabilityUseCase } from "../../application/interfacetemp/useCases/client/IRetryAvailabilityUseCase";
import { allowedTypes, maxSizeMB } from "../../shared/const/constants";
import { IAddReviewUseCase } from "../../application/interfacetemp/useCases/client/IAddReviewUseCase";
import { IReviewStatusUseCase } from "../../application/interfacetemp/useCases/client/IReviewStatusUseCase";
import { IGetProviderReviewsUseCase } from "../../application/interfacetemp/useCases/client/IGetProviderReviewsUseCase";
import { IUpdateReviewUseCase } from "../../application/interfacetemp/useCases/client/IUpdateReviewUseCase";
import { ICreateDisputeAndNotifyUseCase } from "../../application/interfacetemp/useCases/client/ICreateDisputeAndNotifyUseCase";
import { DisputeType } from "../../shared/enums/Dispute";
import { IRescheduleBookingUseCase } from "../../application/interfacetemp/useCases/client/IRescheduleBookingUseCase";
import { IUpdateSelectedLocationUseCase } from "../../application/interfacetemp/useCases/client/IUpdateSelectedLocationUseCase";
import { IRequestEmailUpdateUseCase } from "../../application/interfacetemp/useCases/client/IRequestEmailUpdateUseCase";
import { IConfirmEmailUpdateUseCase } from "../../application/interfacetemp/useCases/client/IConfirmEmailUpdateUseCase";
