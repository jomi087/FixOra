...
export const roleFiled = z.nativeEnum(RoleEnum, { required_error: "Role is required", invalid_type_error: "Invalid role", })


export const houseInfoField = z.string()
export const streetField  = z.string()
export const districtField = z.string().min(1, "Address indvalid missing District field")
export const cityField = z.string().min(1, "Address indvalid missing City field")
export const localityField = z.string().min(1, "Address indvalid missing Locality field")
export const stateField = z.string().min(1, "Address indvalid missing state field")
export const postalCodeField = z.string().min(4, "Address indvalid, Postal code is too short").max(10, "Address indvalid, Postal code is too long")
