...
export function commonOtpEmail({ otp, description }: OtpProps): string {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
      <div class="container">
        <h2 style="text-align:center;color:#222;">${BRAND.NAME} OTP</h2>
        ...
        <p>
          For your security, <strong>do not share this OTP</strong> with anyone .
        </p>
        <div class="footer">
