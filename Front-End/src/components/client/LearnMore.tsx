...
const LearnMore: React.FC<learMoreProps> = ({
  categories,
  providers,
  isPending,
}) => {
  ...
  return (
    <section
      id="learnMore"
      className={"py-10"}
      aria-label={`Information about ${App_Name} services and providers`}
    >
      <div className="container mx-auto px-4">
        ...
        {(!user || user.role === RoleEnum.CUSTOMER) && (
          <div className="">
            ...
            <p
              className="text-center text-sm sm:text-lg font-mono font-medium md:w-3/4 mx-auto pb-5"
              id="service_Provided"
            >
              Complete home care, evolving with you. We are dedicated to
              providing seamless repair solutions while continuously adding new
              ways to keep your home running perfectly.{" "}
            </p>
                ...
                {categories.map((category) => (
                  <SwiperSlide key={category.categoryId} className="p-4 ">
                    <div className="w-[99%] rounded-2xl text-center cursor-pointer shadow-lg shadow-black border ">
                      ...
                      <h6 className="text-lg font-mono mb-2 mt-2">
        ...
        {/* Certified Provider */}
        <div className="mt-10">
          <h3 className="text-xl font-medium text-center pb-5">
            Why Choose {App_Name}?
          </h3>
